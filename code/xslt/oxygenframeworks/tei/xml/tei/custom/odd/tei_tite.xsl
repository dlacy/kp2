...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:esp-d2e31295="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31309="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31323="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31337="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31351="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31365="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31379="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31399="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31409="http://www.tei-c.org/ns/tite/1.0"
                xmlns:esp-d2e31419="http://www.tei-c.org/ns/tite/1.0"
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_tite-teidata.point-deprecate_trailing_decimal_point-7-->


	  <!--RULE -->
   <xsl:template match="*[@points]" priority="1000" mode="M18">
   ...
   <!--PATTERN schematron-constraint-tei_tite-p-abstractModel-structure-p-8-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-p-abstractModel-structure-l-9-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-desc-deprecationInfo-only-in-deprecated-10-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-ptr-ptrAtts-11-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_tite-ref-refAtts-12-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-list-gloss-list-must-have-labels-13-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-l-abstractModel-structure-l-14-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-lg-atleast1oflggapl-15-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-lg-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-ab-abstractModel-structure-ab-17-->
   ...
   <!--PATTERN schematron-constraint-tei_tite-ab-abstractModel-structure-l-18-->


	  <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M29">
