...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_svg-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-p-23-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-link-linkTargets3-24-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-ab-25-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-l-26-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-join-joinTargets3-27-->
