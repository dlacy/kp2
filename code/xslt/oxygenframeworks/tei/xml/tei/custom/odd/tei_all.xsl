...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-teidata.point-deprecate_trailing_decimal_point-9-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-catchwords-catchword_in_msDesc-30-->
   ...
   <!--PATTERN schematron-constraint-tei_all-dimensions-duplicateDim-31-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-secFol-secFol_in_msDesc-32-->
   ...
   <!--PATTERN schematron-constraint-tei_all-signatures-signatures_in_msDesc-33-->
   ...
   <!--PATTERN schematron-constraint-tei_all-msIdentifier-msId_minimal-34-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-reforkeyorname-35-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activemutual-36-->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activepassive-37-->
   ...
   <!--PATTERN schematron-constraint-tei_all-objectIdentifier-objectIdentifier_minimal-38-->
   ...
   <!--PATTERN schematron-constraint-tei_all-shift-shiftNew-39-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-rdgGrp-only1lem-40-->
   ...
   <!--PATTERN schematron-constraint-tei_all-variantEncoding-location-variantEncodingLocation-41-->
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-l-44-->
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-p-45-->
   ...
   <!--PATTERN schematron-constraint-tei_all-path-pathmustnotbeclosed-46-->
   ...
   <!--PATTERN schematron-constraint-tei_all-addSpan-spanTo-47-->
   ...
   <!--PATTERN schematron-constraint-tei_all-damageSpan-spanTo-49-->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-delSpan-spanTo-51-->
   ...
   <!--PATTERN schematron-constraint-tei_all-subst-substContents1-53-->
   ...
   <!--PATTERN schematron-constraint-tei_all-att.repeatable-MINandMAXoccurs-54-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.identified-spec-in-module-55-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_all-att.deprecated-validUntil-deprecation-two-month-warning-56-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.deprecated-validUntil-deprecation-should-be-explained-57-->
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-modref-58-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-prefix-not-same-prefix-59-->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_default_models-60-->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_models-61-->
   ...
   <!--PATTERN schematron-constraint-tei_all-modelSequence-no_outputs_nor_predicates_4_my_kids-62-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M65">
   ...
   <!--PATTERN schematron-constraint-tei_all-content-empty-content-deprecated-63-->


	  <!--RULE -->
   <xsl:template match="tei:content" priority="1000" mode="M66">
