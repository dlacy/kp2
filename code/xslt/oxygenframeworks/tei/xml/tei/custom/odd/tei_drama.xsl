...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_drama-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-p-23-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-link-linkTargets3-24-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-ab-25-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-l-26-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-join-joinTargets3-27-->
