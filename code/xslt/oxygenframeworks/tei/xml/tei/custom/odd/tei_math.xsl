...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_math-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_math-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_math-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_math-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_math-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_math-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_math-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_math-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_math-div-abstractModel-structure-p-23-->
