...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <xsl:template match="tei:note" priority="1000" mode="M31">
		...
		<!--REPORT -->
      <xsl:if test="not(@rend='inside.parenthesis') and following::text()[not(ancestor::tei:note)][1][matches(., '^\)')]">
         <xsl:message>
                    Footnotes may be placed before closing parentheses, though this is
                    exceptionial. If this note's placement is intentional, please mark
                    this with a @rend='inside.parenthesis' attribute. Otherwise, move
                    it after the closing parenthesis.
                   (not(@rend='inside.parenthesis') and following::text()[not(ancestor::tei:note)][1][matches(., '^\)')])</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M31"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-tei_jtei-table-jtei.sch-table-30-->


	  <!--RULE -->
   <xsl:template match="tei:table" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-titleStmt-jtei.sch-title-31-->


	  <!--RULE -->
   <xsl:template match="tei:titleStmt" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-idno-jtei.sch-doi-order-32-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-rendition-jtei.sch-rendition-33-->


	  <!--RULE -->
   <xsl:template match="tei:rendition" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-att-jtei.sch-att-34-->


	  <!--RULE -->
   <xsl:template match="tei:att" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-tag-jtei.sch-tag-35-->


	  <!--RULE -->
   <xsl:template match="tei:tag" priority="1000" mode="M44">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-val-jtei.sch-att-36-->


	  <!--RULE -->
   <xsl:template match="tei:val" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-keywords-39-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-abstract-40-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-text-jtei.sch-article-back-41-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-body-jtei.sch-body-42-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-front-43-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-front2-44-->


	  <!--RULE -->
   <xsl:template match="tei:front/tei:div" priority="1000" mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-back-45-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-divtypes-body-46-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-jtei.sch-div-head-47-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-abstractModel-structure-l-48-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-div-abstractModel-structure-p-49-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-front-jtei.sch-front-abstract-50-->


	  <!--RULE -->
   <xsl:template match="tei:front" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-back-jtei.sch-back-51-->


	  <!--RULE -->
   <xsl:template match="tei:back" priority="1000" mode="M58">
   ...
   <!--PATTERN schematron-constraint-tei_jtei-supplied-jtei.sch-supplied-52-->


	  <!--RULE -->
   <xsl:template match="tei:supplied" priority="1000" mode="M59">
   ...
   <xsl:variable name="tei.version.url"
                 select="'http://www.tei-c.org/release/doc/tei-p5-doc/VERSION'"/>
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-straightApos-55-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-LRquotes-56-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-quotationMarks-57-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-doubleHyphens-58-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-rangeHyphen-59-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-ieEg-60-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-localLinkTarget-61-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-renditionTarget-62-->


	  <!--RULE -->
   <xsl:template match="@rendition" priority="1000" mode="M68">
      <xsl:variable name="orphan.pointers"
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-quoteDelim-63-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossref-id-64-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-formalCrossref-65-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossrefTargetType-66-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-crossrefType-67-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-centuries-68-->
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.sch-teiVersion-69-->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message>
               ...
               <xsl:text/>, and link to the version that can be found in the Vault section. For an overview of all archived versions, see http://www.tei-c.org/Vault/P5/.
   ...
   <!--PATTERN schematron-constraint-tei_jtei-jtei.jtei-url-70-->
