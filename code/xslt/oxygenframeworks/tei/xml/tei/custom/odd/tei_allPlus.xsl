...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-teidata.point-deprecate_trailing_decimal_point-9-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-catchwords-catchword_in_msDesc-30-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-dimensions-duplicateDim-31-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-secFol-secFol_in_msDesc-32-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-signatures-signatures_in_msDesc-33-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-msIdentifier-msId_minimal-34-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-reforkeyorname-35-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activemutual-36-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-relation-activepassive-37-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-objectIdentifier-objectIdentifier_minimal-38-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-shift-shiftNew-39-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.repeatable-MINandMAXoccurs-40-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.identified-spec-in-module-41-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.deprecated-validUntil-deprecation-two-month-warning-42-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-att.deprecated-validUntil-deprecation-should-be-explained-43-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-modref-44-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-moduleRef-prefix-not-same-prefix-45-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_default_models-46-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-model-no_dup_models-47-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-modelSequence-no_outputs_nor_predicates_4_my_kids-48-->
   ...
   <!--PATTERN schematron-constraint-tei_allPlus-content-empty-content-deprecated-49-->
