...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.global.rendition-renditionpointer-5-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.global.rendition-corresppointer-6-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-att.pointing-target-validtarget-9-->


	  <!--RULE -->
   <xsl:template match="tei:*[@target]" priority="1000" mode="M12">
      <xsl:variable name="results"
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-teidata.point-deprecate_trailing_decimal_point-12-->


	  <!--RULE -->
   <xsl:template match="*[@points]" priority="1000" mode="M15">
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-ab-abstractModel-structure-ab-13-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-ab-abstractModel-structure-l-14-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-bibl-noEmptyBibl-15-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-choice-choiceSize-16-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-choice-choiceContent-17-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-desc-deprecationInfo-only-in-deprecated-18-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-div-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-div-abstractModel-structure-p-20-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-l-abstractModel-structure-l-21-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-lg-atleast1oflggapl-22-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-lg-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-list-gloss-list-must-have-labels-24-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-p-abstractModel-structure-p-25-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-p-abstractModel-structure-l-26-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-pb-pbposition-27-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-ref-refAtts-28-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-relatedItem-targetorcontent1-29-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-s-noNestedS-30-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-subst-substContents1-31-->
   ...
   <!--PATTERN schematron-constraint-teisimpleprint-text-headeronlyelement-34-->
