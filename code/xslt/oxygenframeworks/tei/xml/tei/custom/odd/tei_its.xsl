...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_its-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_its-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_its-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_its-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_its-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_its-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-p-23-->
