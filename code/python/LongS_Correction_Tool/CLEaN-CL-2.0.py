...
def main():
    ...
    for prefile in os.listdir():                                                                        # create loop for iteration through files
        ...
        if filename.endswith(".xml"):                                                                   # create loop for iteration through xml files only (precludes processing of "entry_stats" file)
            ...
            file_remove_alpha = open(cwd + "\\test_pairs_removed_dicts_output_leading.txt", 'w+', encoding="utf-8") # open file for appending new leading long-s word pairs
            ...
            file_remove_beta = open(cwd + "\\test_pairs_removed_dicts_output_following.txt", 'w+', encoding="utf-8") # open file for appending new trailing long-s word pairs
