...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_minimal-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_minimal-div-abstractModel-structure-p-23-->
