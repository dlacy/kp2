...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-p-23-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-shift-shiftNew-24-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-reforkeyorname-25-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activemutual-26-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activepassive-27-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-objectIdentifier-objectIdentifier_minimal-28-->


	  <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_speech-link-linkTargets3-29-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-ab-30-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-l-31-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-join-joinTargets3-32-->
