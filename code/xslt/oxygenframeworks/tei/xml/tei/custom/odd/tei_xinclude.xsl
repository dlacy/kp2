...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:esp-d2e54711="http://www.w3.org/2001/XInclude"
                xmlns:esp-d2e54783="http://www.w3.org/2001/XInclude"
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_xinclude-div-abstractModel-structure-p-23-->
