...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-teidata.point-deprecate_trailing_decimal_point-9-->


	  <!--RULE -->
   <xsl:template match="*[@points]" priority="1000" mode="M13">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-l-27-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-p-28-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-reforkeyorname-29-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activemutual-30-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activepassive-31-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-objectIdentifier-objectIdentifier_minimal-32-->


	  <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_ms-path-pathmustnotbeclosed-33-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-addSpan-spanTo-34-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-damageSpan-spanTo-36-->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-delSpan-spanTo-38-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-subst-substContents1-40-->
   ...
   <!--PATTERN schematron-constraint-tei_ms-catchwords-catchword_in_msDesc-41-->


	  <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_ms-dimensions-duplicateDim-42-->


	  <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M41">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-secFol-secFol_in_msDesc-43-->


	  <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_ms-signatures-signatures_in_msDesc-44-->


	  <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_ms-msIdentifier-msId_minimal-45-->
