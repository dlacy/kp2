...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-p-23-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-reforkeyorname-24-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activemutual-25-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activepassive-26-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-objectIdentifier-objectIdentifier_minimal-27-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-link-linkTargets3-28-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-ab-29-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-l-30-->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-join-joinTargets3-31-->
