...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:esp-d2e66308="http://www.example.org/cannot/really/use/XInclude"
                xmlns:esp-d2e66361="http://www.example.org/cannot/really/use/XInclude"
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.typed-subtypeTyped-6-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.pointing-targetLang-targetLang-7-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.styleDef-schemeVersion-schemeVersionRequiresScheme-8-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-p-abstractModel-structure-l-10-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_customization-div-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-div-abstractModel-structure-p-19-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.repeatable-MINandMAXoccurs-20-->


	  <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M27">
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.identified-spec-in-module-21-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.deprecated-validUntil-deprecation-two-month-warning-22-->


	  <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M29">
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.deprecated-validUntil-deprecation-should-be-explained-23-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-if-url-then-prefix-24-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef[ @url ]" priority="1000" mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-no-duplicate-modules-25-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef[ @key ]" priority="1000" mode="M32">
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-element-is-in-module-26-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'header']" priority="1019" mode="M33">
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'core']" priority="1018" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
   ...
   <xsl:template match="tei:moduleRef[@key eq 'textstructure']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'gaiji']" priority="1016" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="every $gi in $include satisfies $gi = ( 'g', 'char', 'charName', 'charProp', 'charDecl', 'glyph', 'glyphName', 'localName', 'mapping', 'unicodeName', 'value' )"/>
         <xsl:otherwise>
            <xsl:message>One or more of the elements included on the '<xsl:text/>
               <xsl:value-of select="@key"/>
               <xsl:text/>' ＜moduleRef＞ are not actually available in that module (every $gi in $include satisfies $gi = ( 'g', 'char', 'charName', 'charProp', 'charDecl', 'glyph', 'glyphName', 'localName', 'mapping', 'unicodeName', 'value' ))</xsl:message>
         </xsl:otherwise>
      </xsl:choose>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="every $gi in $except  satisfies $gi = ( 'g', 'char', 'charName', 'charProp', 'charDecl', 'glyph', 'glyphName', 'localName', 'mapping', 'unicodeName', 'value' )"/>
         <xsl:otherwise>
            <xsl:message>One or more of the elements excepted on the '<xsl:text/>
               <xsl:value-of select="@key"/>
               <xsl:text/>' ＜moduleRef＞ are not actually available in that module (every $gi in $except satisfies $gi = ( 'g', 'char', 'charName', 'charProp', 'charDecl', 'glyph', 'glyphName', 'localName', 'mapping', 'unicodeName', 'value' ))</xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M33"/>
   </xsl:template>
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'verse']" priority="1015" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'drama']" priority="1014" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'spoken']" priority="1013" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
   ...
   <xsl:template match="tei:moduleRef[@key eq 'msdescription']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'transcr']" priority="1010" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
   ...
   <xsl:template match="tei:moduleRef[@key eq 'namesdates']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'figures']" priority="1007" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'corpus']" priority="1006" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'linking']" priority="1005" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="every $gi in $include satisfies $gi = ( 'link', 'linkGrp', 'ab', 'anchor', 'seg', 'when', 'timeline', 'join', 'joinGrp', 'alt', 'altGrp' )"/>
         <xsl:otherwise>
            <xsl:message>One or more of the elements included on the '<xsl:text/>
               <xsl:value-of select="@key"/>
               <xsl:text/>' ＜moduleRef＞ are not actually available in that module (every $gi in $include satisfies $gi = ( 'link', 'linkGrp', 'ab', 'anchor', 'seg', 'when', 'timeline', 'join', 'joinGrp', 'alt', 'altGrp' ))</xsl:message>
         </xsl:otherwise>
      </xsl:choose>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="every $gi in $except  satisfies $gi = ( 'link', 'linkGrp', 'ab', 'anchor', 'seg', 'when', 'timeline', 'join', 'joinGrp', 'alt', 'altGrp' )"/>
         <xsl:otherwise>
            <xsl:message>One or more of the elements excepted on the '<xsl:text/>
               <xsl:value-of select="@key"/>
               <xsl:text/>' ＜moduleRef＞ are not actually available in that module (every $gi in $except satisfies $gi = ( 'link', 'linkGrp', 'ab', 'anchor', 'seg', 'when', 'timeline', 'join', 'joinGrp', 'alt', 'altGrp' ))</xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M33"/>
   </xsl:template>
   ...
   <xsl:template match="tei:moduleRef[@key eq 'analysis']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'iso-fs']" priority="1003" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'nets']" priority="1002" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
   ...
   <xsl:template match="tei:moduleRef[@key eq 'certainty']"
	  ...
	  <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'tagdocs']" priority="1000" mode="M33">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-modref-27-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-include-include-required-28-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-except-need-required-29-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef/@except" priority="1000" mode="M36">
      <xsl:variable name="exceptions" select="tokenize( ., '\s+' )"/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-prefix-not-same-prefix-30-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-required-modules-31-->


	  <!--RULE -->
   <xsl:template match="tei:schemaSpec" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-no-outside-specs-32-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-only-one-schemaSpec-33-->


	  <!--RULE -->
   <xsl:template match="/" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-module-except-when-add-34-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-only-1-per-35-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-dont-delete-required-36-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-content_when_adding-37-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-empty_when_deleting-38-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-altIdent-altIdent-only-NCName-39-->


	  <!--RULE -->
   <xsl:template match="tei:altIdent" priority="1000" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_customization-model-no_dup_default_models-40-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-model-no_dup_models-41-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-modelSequence-no_outputs_nor_predicates_4_my_kids-42-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_customization-content-empty-content-deprecated-43-->


	  <!--RULE -->
   <xsl:template match="tei:content" priority="1000" mode="M50">
   ...
   <!--PATTERN schematron-constraint-tei_customization-sequence-sequencechilden-44-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_customization-alternate-alternatechilden-45-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M52">
   ...
   <!--PATTERN schematron-constraint-tei_customization-constraintSpec-sch_no_more-46-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M53">
   ...
   <!--PATTERN schematron-constraint-tei_customization-constraintSpec-isosch-47-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-constraintSpec-needrules-48-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-attDefContents-49-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M56">
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-noDefault4Required-50-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-defaultIsInClosedList-twoOrMore-51-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-defaultIsInClosedList-one-52-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-dataRef-restrictDataFacet-53-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_customization-dataRef-restrictAttRestriction-54-->
   ...
   <!--PATTERN schematron-constraint-tei_customization-mode-child-sanity-55-->


	  <!--RULE -->
   <xsl:template match="*[ @mode eq 'delete' ]" priority="1001" mode="M62">
   ...
   <!--PATTERN schematron-constraint-tei_customization-tei-source-56-->
