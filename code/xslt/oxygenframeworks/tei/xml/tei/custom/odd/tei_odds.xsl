...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-p-abstractModel-structure-p-9-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-desc-deprecationInfo-only-in-deprecated-11-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ptr-ptrAtts-12-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-ref-refAtts-13-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-list-gloss-list-must-have-labels-14-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-relatedItem-targetorcontent1-15-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_odds-l-abstractModel-structure-l-16-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-atleast1oflggapl-17-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-abstractModel-structure-l-18-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-quotation-quotationContents-19-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-l-22-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-p-23-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.repeatable-MINandMAXoccurs-24-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.identified-spec-in-module-25-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-two-month-warning-26-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-should-be-explained-27-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-modref-28-->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-prefix-not-same-prefix-29-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_default_models-30-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_models-31-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-modelSequence-no_outputs_nor_predicates_4_my_kids-32-->


	  <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_odds-content-empty-content-deprecated-33-->


	  <!--RULE -->
   <xsl:template match="tei:content" priority="1000" mode="M39">
