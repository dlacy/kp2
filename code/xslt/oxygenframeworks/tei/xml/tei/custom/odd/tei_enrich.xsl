...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-teidata.point-deprecate_trailing_decimal_point-9-->
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-reforkeyorname-30-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activemutual-31-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activepassive-32-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-objectIdentifier-objectIdentifier_minimal-33-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-path-pathmustnotbeclosed-34-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-addSpan-spanTo-35-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-damageSpan-spanTo-37-->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-delSpan-spanTo-39-->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-subst-substContents1-41-->
