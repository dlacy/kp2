...
def main():
    ...
    for prefile in os.listdir():                                                                        # create loop for iteration through files
        ...
        if filename.endswith(".xml"):                                                                   # create loop for iteration through xml files only (precludes processing of "entry_stats" file)
            ...
            ambig_words_in_file = open(cwd + "\\AmbiguousPairs_Single_Column.txt","r+", encoding="utf-8")
            ...
            file_remove_alpha = open(cwd + "\\test_pairs_removed_dicts_output_leading.txt", 'a', encoding="utf-8") # open file for appending new leading long-s word pairs
            ...
            file_kept_alpha = open(cwd + "\\test_kept_single_words_output.txt", 'a', encoding="utf-8")    # open file for appending new long-s words
            ...
            ambig_words_in_file_beta = open(cwd + "\\AmbiguousPairs_Single_Column.txt","r+", encoding="utf-8")
            ...
            file_remove_beta = open(cwd + "\\test_pairs_removed_dicts_output_following.txt", 'a', encoding="utf-8") # open file for appending new trailing long-s word pairs
            file_remove_beta.write(write_removed_pairs_beta)                                            # write new trailing long-s word pairs to file
            file_remove_beta.write("\n")                                                                # write new line character to ensure subsequent entries start on a new line
            file_remove_beta.close()                                                                    # close file

            file_kept_beta = open(cwd + "\\test_kept_single_words_output.txt", 'a', encoding="utf-8")            # open file for appending new long-s words
            ...
            master_leading_file_output = open(cwd + "\\before_words_main_uc.txt", "w", encoding="utf-8")        # open master file for writing function output
            ...
            with open(cwd + "\\before_words_main.txt", "w", encoding="utf-8") as lwpc:                          # open file for population with clean data
            ...
            master_trailing_file_output = open(cwd + "\\after_words_main_uc.txt", "w", encoding="utf-8")        # open master file for writing function output
            ...
            master_single_word_file_output = open(cwd + "\\single_words_main_uc.txt", "w", encoding="utf-8")    # open master file for writing function output
            ...
            with open(cwd + "\\single_words_main.txt", "w", encoding="utf-8") as swc:                           # open file for population with clean data
